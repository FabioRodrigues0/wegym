        ...
        <div className="container">
            <div className="row">
                <div className="col">
                    ...
                    {/* COLUNA 1 */}
                    <div onMouseEnter={() => focuSub("One")} onMouseLeave={()=> unFocuSub("One")} id="cardOne" className="card mb-4 box-shadow">
                        <div id="cardOneHeader" className="card-header text-dark">
                            <h4 classNamess="my-0 font-weight-normal">Plano Grátis</h4>
                        </div>
                ...
                <div className="col">
                    ...
                    {/* COLUNA 2 */}
                    <div onMouseEnter={() => focuSub("Two")} onMouseLeave={()=> unFocuSub("Two")} id="cardTwo" className="card mb-4 box-shadow">
                        <div id="cardTwoHeader" className="card-header text-dark">
                            <h4 classNamess="my-0 font-weight-normal">Plano Normal</h4>
                        </div>
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-lg btn-block btn-outline-warning">Regista-te já</button>
                        </div>
                ...
                <div className="col">
                    ...
                    {/* COLUNA 1 */}
                    <div onMouseEnter={() => focuSub("Three")} onMouseLeave={()=> unFocuSub("Three")} id="cardThree" className="card mb-4 box-shadow">
                        <div id="cardThreeHeader" className="card-header text-dark">
                            <h4 classNamess="my-0 font-weight-normal">Plano Premium</h4>
                        </div>
                        <div className="card-body">
