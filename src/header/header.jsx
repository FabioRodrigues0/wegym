                    ...
                    <Form>
                        ...
                        <Modal.Body className='bg-dark'>
                                <Form.Group className="mb-2" controlId="formBasicEmail">
                                    ...
                                    <Form.Control className='border-warning text-warning bg-dark' type="email" placeholder="Enter email" />
                                ...
                                <Form.Group className="mb-3" controlId="formBasicPassword">
                                    ...
                                    <Form.Control className='border-warning text-warning bg-dark' type="password" placeholder="Password" />
                                </Form.Group>
                                <Form.Group className="mb-3" controlId="formBasicCheckbox">
                                    <Form.Check className='border-warning text-warning ckeck-color' type="checkbox" label="Check me out" />
                                </Form.Group>
                        </Modal.Body>
